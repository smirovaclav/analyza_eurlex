...
1. **Načtení legislativy:** Načtení legislativních záznamů z https://eur-lex.europa.eu/ a následné scrapování kodů právních aktů
2. **LLM Extrakce:** Odeslání textů legislativy do LLM (Mistal AI) pro vytěžení požadovaných proměnných a uložení do `result_full.csv` 
